...
class AppStateNotifier extends ChangeNotifier {
  ...
  HaulageCompanyAuthUser? initialUser;
  HaulageCompanyAuthUser? user;
  ...
  void update(HaulageCompanyAuthUser newUser) {
    final shouldUpdate =
        ...
        FFRoute(
          ...
          builder: (context, params) => TransportFormWidget(
            ...
            transportOperationJSON:
                params.getParam('transportOperationJSON', ParamType.JSON),
          ),
        ),
        FFRoute(
